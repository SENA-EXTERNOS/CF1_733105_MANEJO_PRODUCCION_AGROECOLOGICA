      ...
      .row.mb-5
        ...
        .col-lg-6(data-aos="fade-left")
          ...
          .row.justify-content-center
            .col-lg-4
              .cajon.color-secundario.mb-4.text-center
                h5.mb-0.p-3 Perfil del Suelo

          img.img-a.mb-2(src='@/assets/curso/temas/tema_2/img_3.svg', alt='')(data-aos="fade-up")

    h3.my-5(data-aos="fade-up")  Propiedades y composición
